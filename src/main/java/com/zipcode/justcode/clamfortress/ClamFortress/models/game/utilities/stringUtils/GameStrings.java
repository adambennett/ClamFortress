...
public class GameStrings {
    ...
    public static void loadPlayerStats() {
        ...
        String breakLine = "+------------------+------------------+------------------+------------------+------------------+------------------+------------------+------------------+------------------+\n";
        String header = "Stats";
        if (Database.getPlayer() != null) { header = Database.getPlayer().getName() + "'s Stats"; }
        LinkedHashMap<String, ArrayList<String>> top = new LinkedHashMap<>();
        LinkedHashMap<String, ArrayList<String>> bottom = new LinkedHashMap<>();
        ArrayList<String> topCols = new ArrayList<>();
        ArrayList<String> botCols = new ArrayList<>();
...
/*    public static LinkedHashMap<String, ArrayList<String>> getGrid() {
    ...
    public static void loadNames() {
        randomNames = getAllRandomNames(true);
    }

    public static String findRandomName() {
        if (randomNames.size() > 0) {
            return randomNames.get(ThreadLocalRandom.current().nextInt(randomNames.size()));
        }
        return "";
    }
